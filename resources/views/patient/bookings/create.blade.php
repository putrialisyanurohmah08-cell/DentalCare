        ...
        <div class="col-lg-5">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body p-4">
                    ...
                    <h1 class="h4 fw-bold mb-3">Pilih dokter dan tanggal kunjungan</h1>
                    <p class="text-secondary">Sistem akan menampilkan slot yang tersedia berdasarkan jadwal praktik dan kuota harian dokter.</p>
        ...
        <div class="col-lg-7">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body p-4">
                    ...
                    <h2 class="h4 fw-bold mb-3">Pilih layanan dan slot waktu</h2>
                    ...
                    @else
                        <form method="POST" action="{{ route('booking.store') }}" class="d-grid gap-3">
                            ...
                            <div>
                                ...
                                @else
                                    <div class="alert alert-light border">Pilih dokter dan tanggal terlebih dahulu untuk melihat slot tersedia.</div>
                                @endif
                            </div>
                            ...
                            <button class="btn btn-primary rounded-pill" type="submit" @disabled(! $selectedDoctor || empty($availableSlots))>
